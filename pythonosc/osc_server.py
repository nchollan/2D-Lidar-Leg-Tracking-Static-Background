  ...
  try:
    ...
    for timed_msg in packet.messages:
      ...
      for handler in handlers:
        if handler.args:
          handler.callback(timed_msg.time, timed_msg.message.address, handler.args, *timed_msg.message)#MODIFIED
        else:
          handler.callback(timed_msg.time, timed_msg.message.address, *timed_msg.message)#MODIFIED
